...
@Component({
selector: 'app-Book_Return_Report',
templateUrl: './Book_Return_Report.component.html',
styleUrls: ['./Book_Return_Report.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Book_Return_ReportComponent implements OnInit {
    EditIndex: number;
...
Page_Load()
{
    ...
    this.Search_Book_Return_Report();
}

Export()
{
    
        this.Student_Service_.exportExcel(this.Book_Issue_Report_Data,'Book Returned Report')
...
Search_Book_Return_Report()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Search_Books_Return_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),book_no,Registration_No).subscribe(Rows =>{
        debugger
