...
Search_ExamResult_Final()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Search_ExamResult_Final( Batch_Id,this.Login_User).subscribe(Rows =>{
        debugger
...
{
    var R=0,W=0,L=0,S=0,TotalMark=0;
    // G=0, 
   debugger
    ...
    TotalMark = Number(R)+ Number(W) + Number(L)   +Number(S);
    // + Number(G)
...
Search_Examdetails_Final()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Search_Examdetails_Final(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Batch_Id,this.Login_User).subscribe(Rows =>{
...
debugger
    this.issLoading = true;
    this.Student_Service_.Get_ExamresultdetailsFinal(this.Final_Exam_.Final_Exam_Master_Id,this.Final_Exam_.Batch_Id,this.Login_User).subscribe(Rows => {
