...
Search_Fees_Outstanding_Report()
{
    ...
    this.Student_Service_.Search_Fees_Outstanding_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Course_Id,Batch_Id,search_name_,this.Login_User).subscribe(Rows =>{
       debugger
