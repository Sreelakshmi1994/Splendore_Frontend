...
{debugger
    {debugger
            ...
            this.Student_Service_.Get_Dashboard_Count(this.Login_User,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'))
        .subscribe(Rows => 
        {
            debugger
            //console.log(Rows)
            ...
            this.Dashboard_Count8=Rows.returnvalue.Leads[9].Data_Count; 
...
Click_No9()
{
    this.router.navigateByUrl('/Fees_Due_Report');
   
}
Click_No10()
{
    this.router.navigateByUrl('/Fees_Collection_Report');
   
}
Click_No11()
{
    this.router.navigateByUrl('/Leave_Approval');
