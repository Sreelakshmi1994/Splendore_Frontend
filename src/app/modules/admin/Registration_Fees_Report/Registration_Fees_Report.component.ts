...
@Component({
selector: 'app-Registration_Fees_Report',
templateUrl: './Registration_Fees_Report.component.html',
styleUrls: ['./Registration_Fees_Report.component.css'],
providers: [
...
export class Registration_Fees_ReportComponent implements OnInit {
    ...
    // Fees:Registration_Fees_ReportComponent
...
Page_Load()
{
    ...
    this.Get_Menu_Status(103,this.Login_User);
...
Search_Lead_button1() 
{
    ...
    this.Total_Rows=0;
    this.Red_Stop = this.Page_Length_;
    this.Search_Registration_Fees_Report(this.User_Search.Users_Id)
}
Search_More_Options()
{
...
this.Search_Registration_Fees_Report(Users_Id)

}
Search_Registration_Fees_Report(User_Id){
    this.main_View=false
    this.Report_View=true
    this.View_Graph=false
...
debugger
   var Login_User_ =Number(this.Login_User) 


    this.issLoading = true;
    debugger
    this.Student_Service_.Search_Registration_Fees_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), 
    moment(this.Search_ToDate).format('YYYY-MM-DD'), search_name_, User_Id,   look_In_Date_Value, Login_User_)
.subscribe(Rows => 
{
