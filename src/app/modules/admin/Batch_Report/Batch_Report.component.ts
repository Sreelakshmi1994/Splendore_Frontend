...
Search_Batch_Report()
{
    var  Course_Id = 0, Batch_Id = 0,search_name_ = undefined,look_In_Date_Value=0;var Faculty_Id =0;
    ...
    this.Student_Service_.Search_Batch_Report(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),Batch_Id,Faculty_Id,this.Login_User).subscribe(Rows =>{
        debugger
