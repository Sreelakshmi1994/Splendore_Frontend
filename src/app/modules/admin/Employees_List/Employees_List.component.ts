...
@Component({
selector: 'app-Employees_List',
templateUrl: './Employees_List.component.html',
styleUrls: ['./Employees_List.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
 
export class Employees_ListComponent implements OnInit {
    EditIndex: number;
    ...
    issLoading: boolean;
    Permissions: any;
    Employees_List_Edit:boolean;
    Employees_List_Save:boolean;
    Employees_List_Delete:boolean;
    ...
    Login_User: number = 0;
    Employees_List_EditIndex: number = -1;
...
{debugger
    ...
    {
    this.Employees_List_Edit=this.Permissions.Edit;
    this.Employees_List_Save=this.Permissions.Save;
    this.Employees_List_Delete=this.Permissions.Delete;
    debugger
    this.Page_Load()
...
Export()
{
        ...
        this.Student_Service_.exportExcel(this.Employees_List_Data,'Employees List')
...
Search_Employees_List()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Search_Employees_List(look_In_Date_Value,moment(this.FromDate_).format('YYYY-MM-DD'), moment(this.ToDate_).format('YYYY-MM-DD'),User_Id).subscribe(Rows =>{
        debugger
    this.Employees_List_Data = Rows[0];
    this.Total_Entries = this.Employees_List_Data.length;
    this.issLoading = false;
    if(this.Employees_List_Data.length==0)
    { 
    this.issLoading=false;
