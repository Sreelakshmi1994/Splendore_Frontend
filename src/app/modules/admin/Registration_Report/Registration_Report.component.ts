...
{
var value = 1, Status_Id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0,Enquiry_For_Id_=0;;
    ...
    this.Student_Service_.Search_Registration_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'),
     ...
     look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop,Enquiry_For_Id_)
.subscribe(Rows => 
{
