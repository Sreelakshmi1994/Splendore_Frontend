...
@Component({
selector: 'app-Candidate_List',
templateUrl: './Candidate_List.component.html',
styleUrls: ['./Candidate_List.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class Candidate_ListComponent implements OnInit {
    EditIndex: number;
...
ngOnInit() 
{
    ...
    this.Permissions = Get_Page_Permission(61);
...
Page_Load()
{
   ...
   this.Load_Markstatus();
    ...
    this.myInnerHeight = this.myInnerHeight - 390;
...
Search_Course_Typeahead_Formastercourse(event: any) {
    ...
    this.Student_Service_.Search_Course_Typeahead_Formastercourse(Value,this.CourseSearch_.MasterCourse_Id).subscribe(
    (Rows) => {
...
// Duration_Change(Course_Temp: Course)
// {
//   debugger
//   this.Student_Course_.Duration=Number(Course_Temp.Duration);
// }
