...
@Component({
  selector: 'app-application-collection-report',
  templateUrl: './application-collection-report.component.html',
  styleUrls: ['./application-collection-report.component.scss'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})
export class ApplicationCollectionReportComponent implements OnInit {
    EditIndex: number;
