...
ngOnInit() 
{
this.Permissions = Get_Page_Permission(85);
...
Save_Client_Accounts()
{
    ...
    {
    const dialogRef = this.dialogBox.open( DialogBox_Component, {panelClass:'Dialogbox-Class',data:{Message:'Bank Name Already Exists',Type:"2"}});
   }
    else{
