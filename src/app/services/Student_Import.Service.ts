...
return this.http.post(environment.BasePath +'Student/Save_Student_Import/',Student_Details);
 ...
 Save_Level_Import(Student_Details)
 {   
  debugger
 return this.http.post(environment.BasePath +'Student/Save_Level_Import/',Student_Details);
 }
 Save_Data_Migration(Student_Details)
 {   
  debugger
 return this.http.post(environment.BasePath +'Import/Save_Data_Migration/',Student_Details);
 }
